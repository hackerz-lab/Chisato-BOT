...
console.log(color('\nYou can follow me on GitHub: FantoX001','aqua'))
    ...
    const Miku = MikuConnect({
        ...
        browser: ['Chisato by: Hackerz-Lab','Safari','1.0.0'],
        auth: state,
        version
    })
...
Miku.ev.on('groups.update', async pea => {
       ...
       ppgc = 'https://image-0.uhdpaper.com/wallpaper/lycoris-recoil-chisato-nishikigi-phone-wallpaper-4k-uhdpaper.com-645@0@g.jpg'
       }
        ...
        try {
            ...
            for (let num of participants) {
                ...
                try {
                    ...
                    ppuser = 'https://image-0.uhdpaper.com/wallpaper/lycoris-recoil-chisato-nishikigi-phone-wallpaper-4k-uhdpaper.com-645@0@g.jpg'
                }

                try {
                    ppgroup = await Miku.profilePictureUrl(anu.id, 'image')
                } catch {
                    ppgroup = 'https://image-0.uhdpaper.com/wallpaper/lycoris-recoil-chisato-nishikigi-phone-wallpaper-4k-uhdpaper.com-645@0@g.jpg'
                }
...
I am *Chisato*, Welcome to ${metadata.subject}.
